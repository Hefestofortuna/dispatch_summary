...
use backend\models\UserSearchSearch;
...
class UserSearchController extends Controller
{
    ...
    {
        $searchModel = new UserSearchSearch();
    ...
    /**
     * Creates a new UserSearch model.
    ...
    /**
     * Updates an existing UserSearch model.
    ...
    /**
     * Deletes an existing UserSearch model.
    ...
    {
        if (($model = UserSearch::findOne($id)) !== null) {
            return $model;
        }
