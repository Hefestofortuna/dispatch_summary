...
class User extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['status', 'created_at', 'updated_at', 'subdivision_id', 'organization_id', 'post_id'], 'default', 'value' => null],
            [['status', 'created_at', 'updated_at', 'subdivision_id', 'organization_id', 'post_id'], 'integer'],
    ...
    {
        return $this->hasMany(NewsUser::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(News::className(), ['id' => 'news_id'])->viaTable('news_user', ['user_id' => 'id']);
    }
